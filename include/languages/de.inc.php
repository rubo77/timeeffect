<?php
	...
	$GLOBALS['_PJ_strings']['pdf_logo_height']			= 'Logo Höhe (in pt)';
	...
	$GLOBALS['_PJ_strings']['pdf_footer_string']		= 'Fußzeile 1. Seite';
	$GLOBALS['_PJ_strings']['pdf_print_footer']			= 'Fußzeile drucken';
	$GLOBALS['_PJ_strings']['pdf_print_footer_line']	= 'Linie über Fußzeile anzeigen';
	$GLOBALS['_PJ_strings']['pdf_print_footer_string']	= 'Fußzeile 1. Seite anzeigen';
	...
	$GLOBALS['_PJ_strings']['pdf_head_right']			= 'Einzug für Abrechnungsdetails (in pt)';
	$GLOBALS['_PJ_strings']['pdf_bottom_margin']		= 'Seitenrand unten (in pt)';
	$GLOBALS['_PJ_strings']['pdf_footer_margin']		= 'Abstand der Fußzeile zur Seite (in pt)';
	$GLOBALS['_PJ_strings']['pdf_table_cell_spacing']	= 'Abstand zwischen den Tabellenzellen (in pt)';
	$GLOBALS['_PJ_strings']['pdf_mini_font_size']		= 'Schriftgröße Mini-Schrift (in pt)';
	$GLOBALS['_PJ_strings']['pdf_footer_font_size']		= 'Schriftgröße Fußzeile (in pt)';
	$GLOBALS['_PJ_strings']['pdf_small_font_size']		= 'Schriftgröße Klein (in pt)';
	$GLOBALS['_PJ_strings']['pdf_header_font_size']		= 'Schriftgröße Kopfzeile (in pt)';
	$GLOBALS['_PJ_strings']['pdf_sum_spacing']			= 'Abstand vor der Summenzeile (in pt)';
	$GLOBALS['_PJ_strings']['pdf_print_margins']		= 'Zeige Seitenränder (als graue Linie)';
	$GLOBALS['_PJ_strings']['pdf_table_head_bg_r']		= 'Hintergrund-Farbe der Tabellenkopfzeile (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_head_bg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_head_bg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_head_fg_r']		= 'Schrift-Farbe der Tabellenkopfzeile (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_head_fg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_head_fg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row0_bg_r']		= 'Hintergrund-Farbe gerade Tabellenzeilen (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_row0_bg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row0_bg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row1_bg_r']		= 'Hintergrund-Farbe ungerade Tabellenzeilen (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_row1_bg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row1_bg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row0_fg_r']		= 'Schrift-Farbe gerade Tabellenzeilen (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_row0_fg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row0_fg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row1_fg_r']		= 'Schrift-Farbe ungerade Tabellenzeilen (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_row1_fg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_row1_fg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_sum_bg_r']		= 'Hintergrund-Farbe Summenzeile (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_sum_bg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_sum_bg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_sum_fg_r']		= 'Schrift-Farbe Summenzeile (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_table_sum_fg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_table_sum_fg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_footnote_bg_r']		= 'Hintergrund-Farbe Fußnoten (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_footnote_bg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_footnote_bg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_footnote_fg_r']		= 'Schrift-Farbe Fußnoten (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_footnote_fg_g']		= '';
	$GLOBALS['_PJ_strings']['pdf_footnote_fg_b']		= '';
	$GLOBALS['_PJ_strings']['pdf_footer_bg_r']			= 'Hintergrund-Farbe Fußzeile (rot, grün, blau zwischen 0 und 255)';
	$GLOBALS['_PJ_strings']['pdf_footer_bg_g']			= '';
	$GLOBALS['_PJ_strings']['pdf_footer_bg_b']			= '';
	$GLOBALS['_PJ_strings']['pdf_footer_fg_r']			= 'Schrift-Farbe Fußzeile (rot, grün, blau zwischen 0 und 255)';
