<?php
	...
	$_PJ_csv_statistics_script		= $_PJ_http_root . '/statistic/csv.'		. $_PJ_php_suffix;
	$_PJ_pdf_statistics_script		= $_PJ_http_root . '/statistic/pdf.'		. $_PJ_php_suffix;
	$_PJ_pdf_admin_script			= $_PJ_http_root . '/admin/pdflayout.'		. $_PJ_php_suffix;
